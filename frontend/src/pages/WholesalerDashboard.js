...
import { Package, DollarSign, ShoppingCart, Plus, Edit2, Trash2, Users } from 'lucide-react';
...
const WholesalerDashboard = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const [productsRes, categoriesRes, statsRes] = await Promise.all([
        ...
        dashboardAPI.getWholesalerDashboard(user.id),
      ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="wholesaler-dashboard">
      <Navbar />
      
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2" data-testid="dashboard-title">Wholesaler Dashboard</h1>
