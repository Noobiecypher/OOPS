...
import { Package, MapPin, CreditCard, Clock, ArrowLeft } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card data-testid="order-header">
              <CardContent className="pt-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h1 className="text-2xl font-bold mb-1" data-testid="order-id">
                  ...
                  <Badge
                    className={order.order_status === 'delivered' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'}
            ...
            {order.order_status !== 'cancelled' && (
              <Card data-testid="order-tracking">
                <CardHeader>
                ...
                <div className="space-y-4">
                  {order.items.map((item, index) => (
                    <div key={index} className="flex items-center justify-between py-3 border-b last:border-0">
                      <div className="flex-1">
                        <p className="font-semibold" data-testid={`item-name-${index}`}>{item.product_name}</p>
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6 sticky top-20">
              {/* Price Summary */}
              <Card data-testid="price-summary">
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600" data-testid="delivery-address">{order.delivery_address}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 capitalize" data-testid="payment-method">
