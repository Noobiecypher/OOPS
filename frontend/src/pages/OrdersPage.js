  ...
  return (
    <div className="min-h-screen bg-gray-50" data-testid="orders-page">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8" data-testid="orders-title">My Orders</h1>

        {orders.length === 0 ? (
          <Card className="max-w-md mx-auto text-center py-12" data-testid="no-orders">
            <CardContent>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="font-semibold text-lg mb-1" data-testid={`order-id-${order.id}`}>
                    ...
                    <div className="text-right">
                      ...
                      <Badge className={`mt-2 ${getStatusColor(order.order_status)}`} data-testid={`order-status-${order.id}`}>
